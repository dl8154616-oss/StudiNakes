...
export default function HomeCardFeaturedExams() {
  return (
        ...
        <div className="col-md-4">
          <div className="card" style={{ width: '288px', backgroundColor: '#ffffffff', color: 'black', borderRadius: '10px' }}>
            ...
            <div className="d-flex justify-content-center align-items-center p-4">
              <img 
                src="https://via.placeholder.com/150?text=PMP+Logo" 
                alt="PMP Logo" 
            ...
            <div className="card-body text-left">
              <h5 className="card-title" style={{ fontSize: '14px', fontFamily: 'Poppins'}}>Project Management Professional</h5>
